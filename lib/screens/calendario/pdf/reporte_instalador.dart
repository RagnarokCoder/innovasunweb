// ignore_for_file: avoid_web_libraries_in_flutter, unused_local_variable, unnecessary_string_interpolations, unnecessary_null_comparison, depend_on_referenced_packages, unused_import
...
import '../components/select_user.dart';

dynamic total = 0;
Future<void> reporteInstalador(Size size) async {
  total = 0;
  debugPrint(instalacionesPdf.toString());
  ...
  await saveAndLaunchFile(bytes, 'reporteInstalador.pdf');
}
