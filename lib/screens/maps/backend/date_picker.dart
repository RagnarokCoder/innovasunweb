...
rangoFechaInstalacionMap(
  ...
  return normalButton("Fechas", colorOrangLiU, colorOrangLiU, size, () async {
    ...
    if (values != null) {
      setter(() {
        ...
        rInstalaciones.clear();
        for (var r in instalaciones.keys) {
          DateTime fecha = instalaciones[r]['fecha'].toDate();
          if (fecha.isAfter(rangoA!) && fecha.isBefore(rangoB!)) {
            rInstalaciones.putIfAbsent(r, () => instalaciones[r]);
          }
        }
